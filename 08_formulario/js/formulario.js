...
var mf = {
    ...
    validarFormulario: function() {
        ...
        if (!pf.validarUsuario || !pf.validarPassword || !pf.validarEmail) {
            ...
            document.querySelector("#labelEnviar").innerHTML = '<pan style="color:red">¡*Tiene errores en los datos que ha ingresado, por favor revisar de nuevos!</span>'

            return false

        } else if (!pf.validarTerminos) {

            document.querySelector("#labelEnviar").innerHTML = '<pan style="color:red">¡*Favor acepte los términos y condiciones!</span>'
