...
// OBJETO CON LOS MÉTODOS DE LA CALCÚLADORA
...
var m = {
    ...
    calculadora: function(accion, digito) {
        switch (accion) {
            ...
            case "decimal":
                //Agregamos en la condicion del decimal que la cantidad
                // de signos debe ser diferente a 1
            ...
            case "igual":
                p.operaciones.innerHTML = eval(p.operaciones.innerHTML)
                    // Evaluamos con una expresion regular si en el 
                    // resultado ya existe un decimal
                var expresion = /./g
